...
const DigitalMarketerForm = ({ profile, onChange, errors = {}, activeSection, onSectionChange }) => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="md:col-span-2">
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              placeholder="e.g., Digital Marketer | SEO Specialist | Social Media Manager"
            />
          ...
          <div className="md:col-span-2">
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              placeholder="1-2 lines about your marketing expertise..."
            />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <input
                ...
                onChange={onChange}
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                placeholder="e.g., View Campaigns"
              />
            </div>
          ...
          <div className="md:col-span-2">
            ...
            <div className="space-y-3">
              {['LinkedIn', 'Twitter/X', 'Instagram', 'Facebook', 'YouTube', 'TikTok'].map((platform, idx) => {
              ...
              {(profile.identity?.resumeFiles || []).map((resume, index) => (
                <div key={index} className="flex items-center gap-3 p-3 border border-gray-200 rounded-lg">
                  <input
                    ...
                    className="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    placeholder="e.g., Full Resume, Digital Marketing Resume"
                  />
                  <input
                    type="text"
                    value={resume.url || ''}
        ...
        <div className="space-y-6">
          <div>
            ...
            <textarea
              ...
              rows={6}
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              placeholder="Tell your professional marketing story..."
            />
          </div>
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
              Marketing Philosophy (comma separated)
            </label>
            <input
              type="text"
              name="about.marketingPhilosophy"
              value={profile.about?.marketingPhilosophy?.join(', ') || ''}
              onChange={(e) => {
                const philosophy = e.target.value.split(',').map(item => item.trim()).filter(item => item);
                onChange({ target: { name: 'about.marketingPhilosophy', value: philosophy } });
              }}
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              placeholder="e.g., Data-driven marketing, Customer-centric, ROI-focused"
            />
          </div>
          ...
          {(profile.campaigns || []).map((campaign, index) => (
            <div key={index} className="border border-gray-200 rounded-lg p-4 space-y-4">
              <div className="flex items-center justify-between">
                <h4 className="font-medium text-gray-900">Campaign {index + 1}</h4>
                <button
                  type="button"
                  onClick={() => removeArrayItem('campaigns', index)}
                  className="p-2 text-red-500 hover:bg-red-50 rounded-lg"
                >
                  <X size={16} />
                </button>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => handleArrayChange('campaigns', index, { ...campaign, title: e.target.value })}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) => handleArrayChange('campaigns', index, { ...campaign, description: e.target.value })}
                  rows={3}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => handleArrayChange('campaigns', index, { ...campaign, platform: e.target.value })}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleArrayChange('campaigns', index, { ...campaign, budget: e.target.value })}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) => handleArrayChange('campaigns', index, { ...campaign, results: e.target.value })}
                  rows={2}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleArrayChange('campaigns', index, { ...campaign, startDate: e.target.value })}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleArrayChange('campaigns', index, { ...campaign, endDate: e.target.value })}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
