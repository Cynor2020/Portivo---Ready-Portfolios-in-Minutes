...
const GraphicDesignerForm = ({ profile, onChange, errors = {}, activeSection, onSectionChange }) => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="md:col-span-2">
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              placeholder="e.g., Graphic Designer | Visual Artist"
            />
          ...
          <div className="md:col-span-2">
            ...
            <div className="space-y-3">
              {['Behance', 'Dribbble', 'LinkedIn', 'Instagram', 'Twitter/X', 'Adobe Portfolio'].map((platform, idx) => {
              ...
              {(profile.identity?.resumeFiles || []).map((resume, index) => (
                <div key={index} className="flex items-center gap-3 p-3 border border-gray-200 rounded-lg">
                  <input
                    ...
                    className="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    placeholder="e.g., Full Resume, Graphic Design Resume"
                  />
                  <input
                    type="text"
                    value={resume.url || ''}
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              placeholder="e.g., Visual storytelling, Brand consistency, Creative expression"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              placeholder="e.g., Branding, Advertising, Publishing"
            />
          </div>
  ...
  const renderPortfolioSection = () => (
    <div className="space-y-6">
      <div className="bg-card rounded-xl p-6 shadow-lg shadow-black/40 border border-zinc-800">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Visual Portfolio</h3>
        ...
        <div className="space-y-4">
            ...
            <div key={index} className="border border-gray-200 rounded-lg p-4 space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) => handleArrayChange('visualPortfolio', index, { ...work, description: e.target.value })}
                  rows={3}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              ...
              <div>
                ...
                <select
                  value={work.category || ''}
                  onChange={(e) => handleArrayChange('visualPortfolio', index, { ...work, category: e.target.value })}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                >
              ...
              <div>
                ...
                <input
                  type="text"
                  value={work.client || ''}
                  onChange={(e) => handleArrayChange('visualPortfolio', index, { ...work, client: e.target.value })}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          ...
          <button
            type="button"
            onClick={() => addArrayItem('visualPortfolio', { image: '', title: '', description: '', category: '', client: '' })}
            className="flex items-center gap-2 px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600"
          >
            <Plus size={16} />
            Add Portfolio Item
